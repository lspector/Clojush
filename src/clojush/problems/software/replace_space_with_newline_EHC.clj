...
(ns clojush.problems.software.replace-space-with-newline-EHC
...
(def argmap
  {:error-function (replace-space-error-function replace-space-data-domains)
   ...
   :max-generations 10e100
   :max-point-evaluations (* 1000 1000 100 300) ;; popsize (1000) * #points per eval (1000) * #test cases (100) * max gens (300)
...
;                                    }
   ...
   :genetic-operator-probabilities {[:alternation :make-next-operator-revertable :uniform-silence-mutation] 0.2
                                    [:uniform-mutation :make-next-operator-revertable :uniform-silence-mutation] 0.2
                                    [:uniform-close-mutation :make-next-operator-revertable :uniform-silence-mutation] 0.1
                                    [:alternation :uniform-mutation :make-next-operator-revertable :uniform-silence-mutation] 0.5
                                    }
   :silent-instruction-probability 0.5
