...
(ns clojush.problems.software.replace-space-with-newline-epiline-without-hill-climbing
...
;                                    }
   ...
   :genetic-operator-probabilities {[:alternation :uniform-silence-mutation] 0.2
                                    [:uniform-mutation :uniform-silence-mutation] 0.2
                                    [:uniform-close-mutation :uniform-silence-mutation] 0.1
                                    [:alternation :uniform-mutation :uniform-silence-mutation] 0.5
                                    }
