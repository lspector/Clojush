;; autoconstructive_last_index_of_zero.clj
;; A version of last_index_of_zero.clj modified to use only the autoconstriction
...
;; Documentation for the original last_index_of_zero.clj file:
...
(ns clojush.problems.autoconstruction.autoconstructive-last-index-of-zero ;; #auto
...
(def last-index-of-zero-atom-generators
  (concat (list
          ...
          (registered-for-stacks [:integer :boolean :vector_integer :exec :genome]))) ;; #auto
