;; autoconstructive_replace_space_with_newline.clj
;; A version of replace_space_with_newline.clj modified to use only the autoconstriction
;; genetic operator. Changes from standard version marked #auto.
...
;; Documentation for the original replace_space_with_newline.clj file:
...
(ns clojush.problems.demos.autoconstructive-replace-space-with-newline
...
(def replace-space-atom-generators
  (concat (list
            ...
            'autoconstructive_integer_rand ;; #auto
            )
          (registered-for-stacks [:integer :boolean :string :char :exec :print :genome]))) ;; #auto
